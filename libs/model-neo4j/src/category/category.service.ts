...
import { NodeRelationship, SupportedLabel } from '@nx-study/data'
import {
...
import { getRecordsByKey, IMammothCoreNode, Neo4jService, RxResult } from '../neo4j'
...
export class CategoryService extends CommonAccountService implements ICommonAccountConverter {
   ...
   */
  public createCategory(request: CreateCategoryDto): Observable<ICategory> {
    if (request.parentId) {
