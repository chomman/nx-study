...
import { getRecordsByKey, getRecordsByKeyNotification, Neo4jService, RxResult } from '../neo4j'
import { CreateBudgetDto, BudgetQuery, UpdateBudgetDto } from './dto'
import {
  deleteBudgetById,
  getBudgetById,
  getBudgetsByQuery,
...
export class BudgetService {
   ...
   */
  public createBudget(request: CreateBudgetDto): Observable<IBudget> {
   ...
   * @memberof BudgetService
   */
  public saveBudget(request: UpdateBudgetDto): Observable<IBudget> {
